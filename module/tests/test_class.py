...
class OrderClassTestCase(TestCase):
    ...
    def test_order_id_counter_change(self):
        ...
        self.assertEqual(order_1, 'order--6', f"Expected 'order--1', got {order_1}")
        self.assertEqual(order_2, 'order--7', f"Expected 'order--2', got {order_2}")
    ...
    def test_order_creation_exception_MealTooBigError(self):
        result = Order(['meal-4','meal-4','combo-2','meal-4','combo-3']).order_refused_reason
